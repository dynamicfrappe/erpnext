...
def getdata(filters):
    ...
    if filters.get("Company"):
        ...
        purchase_total_row['tax_amount_positive'] = "<b> " + str(purchase_invoices_totals[0].tax_amount_positive) + "</b>"
        purchase_total_row['tax_amount_negative'] = "<b> " + str(purchase_invoices_totals[0].tax_amount_negative) + "</b>"
        empty_row = frappe._dict()
        ...
        total_row['tax_amount_positive'] = "<b> " + str(sales_invoices_totals[0].tax_amount_positive - purchase_invoices_totals[0].tax_amount_positive) +"</b>"
        total_row['tax_amount_negative'] = "<b> "+ str(purchase_invoices_totals[0].tax_amount_negative - sales_invoices_totals[0].tax_amount_negative) +"</b>"
